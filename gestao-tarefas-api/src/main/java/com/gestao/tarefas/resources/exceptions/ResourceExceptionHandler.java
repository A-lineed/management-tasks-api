...
public class ResourceExceptionHandler {
	...
	@ExceptionHandler(DataIntegritViolationException.class)
	public ResponseEntity<StandardError>DataIntegritViolationException(DataIntegritViolationException e, ServletRequest request){
